...
import static com.yuepeng.wxb.utils.BitmapUtil.bmEnd;
import static com.yuepeng.wxb.utils.BitmapUtil.bmStart;
...
//        }
    ...
    public void setCenter(LatLng center) {
        if (center!=null && !CommonUtil.isZeroPoint(center.latitude, center.longitude)) {
            LatLng currentLatLng = new LatLng(center.latitude, center.longitude);
        ...
        //if (!TextUtils.isEmpty(lastLocation)) {
            ...
            if (location!=null && !CommonUtil.isZeroPoint(location.latitude,
                    location.longitude)) {
                updateStatus(location, false);
                return;
            }
        //}
    }
    ...
    public void updateStatus(LatLng currentPoint, boolean showMarker) {
        ...
        if (null != baiduMap.getProjection()) {
            ...
            if (screenPoint.y < 200 || screenPoint.y > heightPixels - 500
                    || screenPoint.x < 200 || screenPoint.x > widthPixels - 200
                    || null == mapStatus) {
...
//        if (null == mMoveMarker || mMoveMarker.isRemoved()) {
...
//        }
    ...
    public void setCurrentAccracy(float mCurrentAccracy) {
        this.mCurrentAccracy = mCurrentAccracy;
    }
}
